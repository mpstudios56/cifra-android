...
import static tw.tib.financisto.utils.EnumUtils.selectEnum;

public class AccountWidget extends AppWidgetProvider {

    private static final Uri CONTENT_URI = Uri.parse("content://tw.tib.financisto/accountwidget");

    private static final String WIDGET_UPDATE_ACTION = "tw.tib.financisto.UPDATE_WIDGET";
    private static final String PREFS_NAME = "tw.tib.financisto.activity.financisto.AccountWidget";
