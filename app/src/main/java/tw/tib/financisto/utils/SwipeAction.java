...
public enum SwipeAction {
    ...
    EDIT(R.string.edit, 0xFFE0A33C, R.drawable.ic_menu_edit, R.string.swipe_done_edit),
    DUPLICATE(R.string.duplicate, 0xFF6C8CF5, R.drawable.ic_duplicate, R.string.swipe_done_duplicate),
    ...
    DELETE(R.string.delete, 0xFFE5484D, R.drawable.ic_menu_delete, R.string.swipe_done_delete);
