 ...
 */
package io.github.mpstudios56.cifra.sync;
...
public class SyncFolder {
    ...
    public static String nameFor(String author, String deviceId) {
        return nameFor(author, io.github.mpstudios56.cifra.utils.MyPreferences.getSyncGroupCode(), deviceId);
    }
    ...
    private static String groupPart() {
        String group = tidy(io.github.mpstudios56.cifra.utils.MyPreferences.getSyncGroupCode());
    ...
    public List<String> readOthers(String author, String deviceId) {
        ...
        try {
            ...
            for (DocumentFile file : folder.listFiles()) {
                ...
                Log.i(TAG, "reading " + name);
                String[] who = io.github.mpstudios56.cifra.sync.People.fromFileName(name);
                if (who != null) {
                    seen.add(who);
                }
                read(file, lines);
