...
import io.github.mpstudios56.cifra.adapter.ReportAdapter;
...
import io.github.mpstudios56.cifra.report.PeriodReport;
import io.github.mpstudios56.cifra.report.Report;
import io.github.mpstudios56.cifra.report.ReportData;
...
public class ReportActivity extends ListActivity implements RefreshSupportedActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean anybody = !io.github.mpstudios56.cifra.sync.People.all(db.db()).isEmpty();
    ...
    private WhereFilter reportFilter() {
        ...
        if (!includeShared) {
            f.put(io.github.mpstudios56.cifra.model.Budget.onlyMine());
        }
        return f;
    }
