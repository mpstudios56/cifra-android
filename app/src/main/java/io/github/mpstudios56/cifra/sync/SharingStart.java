...
import io.github.mpstudios56.cifra.db.ChangeLog;
...
public class SharingStart {
    ...
    private static boolean openingLine(SQLiteDatabase db, long accountId,
        ...
        try {
            ...
            o.put("note", io.github.mpstudios56.cifra.Application.getInstance()
                    .getString(io.github.mpstudios56.cifra.R.string.opening_amount)
                    + " (" + accountTitle + ")");
            o.put("status", "UR");
