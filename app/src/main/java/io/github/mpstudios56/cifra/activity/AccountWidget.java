...
import static io.github.mpstudios56.cifra.utils.EnumUtils.selectEnum;

public class AccountWidget extends AppWidgetProvider {

    private static final Uri CONTENT_URI = Uri.parse("content://io.github.mpstudios56.cifra/accountwidget");

    private static final String WIDGET_UPDATE_ACTION = "io.github.mpstudios56.cifra.UPDATE_WIDGET";
    private static final String PREFS_NAME = "io.github.mpstudios56.cifra.activity.financisto.AccountWidget";
    ...
    private static RemoteViews buildUpdateForCurrentAccount(Context context, int widgetId, int layoutId, Class providerClass, long accountId) {
        ...
        try {
            ...
            Log.e(AccountWidget.class.getSimpleName(), "buildUpdateForCurrentAccount", ex);
