...
import io.github.mpstudios56.cifra.sync.Duplicates;
...
public class DuplicatesActivity extends AppCompatActivity {
    ...
    private String[] readOne(String uuid) {
        ...
        try (Cursor c = db.db().rawQuery(sql, new String[]{uuid})) {
            ...
            String money = io.github.mpstudios56.cifra.utils.Utils.amountToString(
                    io.github.mpstudios56.cifra.utils.CurrencyCache.getHomeCurrency(), amount);
