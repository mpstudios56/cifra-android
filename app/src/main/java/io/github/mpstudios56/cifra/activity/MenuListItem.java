...
import io.github.mpstudios56.cifra.export.qif.QifExportTask;
import io.github.mpstudios56.cifra.export.qif.QifImportOptions;
import io.github.mpstudios56.cifra.export.qif.QifImportTask;
import io.github.mpstudios56.cifra.db.DatabaseAdapter;
import io.github.mpstudios56.cifra.export.BackupExportTask;
import io.github.mpstudios56.cifra.export.Export;
import io.github.mpstudios56.cifra.export.csv.CsvExportOptions;
import io.github.mpstudios56.cifra.export.csv.CsvExportTask;
import io.github.mpstudios56.cifra.export.csv.CsvImportTask;
import io.github.mpstudios56.cifra.export.SettingsExportTask;
import io.github.mpstudios56.cifra.utils.DonatePrompt;
import io.github.mpstudios56.cifra.utils.EntityEnum;
import io.github.mpstudios56.cifra.utils.Feedback;
...
import io.github.mpstudios56.cifra.utils.IntegrityFix;
        ...
        MENU_SECURITY(R.string.protection, R.drawable.ic_action_lock) {
            ...
            public void execute(Fragment fragment) {
                ...
                intent.putExtra(PreferencesActivity2.SCREEN_EXTRA,
                        "io.github.mpstudios56.cifra.preference.SecurityPreferencesFragment");
                fragment.startActivity(intent);
            }
        },
        /** Where the copies go, and how often: settings beside the buttons that use them. */
        MENU_BACKUP_SETTINGS(R.string.backup_settings, R.drawable.ic_action_gear) {
            @Override
            public void execute(Fragment fragment) {
                Intent intent = new Intent(fragment.getContext(), PreferencesActivity2.class);
                intent.putExtra(PreferencesActivity2.SCREEN_EXTRA,
