...
import io.github.mpstudios56.cifra.model.AccountForSearch;
...
import io.github.mpstudios56.cifra.orb.Query;
...
public abstract class MyEntityManager extends EntityManager {
	...
	public long saveOrUpdate(io.github.mpstudios56.cifra.model.Currency currency) {
		SQLiteDatabase db = db();
		db.beginTransaction();
		try {
	...
	public Cursor getAllCurrencies(String sortBy) {
		Query<io.github.mpstudios56.cifra.model.Currency> q = createQuery(io.github.mpstudios56.cifra.model.Currency.class);
		return q.desc("isDefault").asc(sortBy).execute();
	}

	public List<io.github.mpstudios56.cifra.model.Currency> getAllCurrenciesList() {
		return getAllCurrenciesList("name");
	}

	public List<io.github.mpstudios56.cifra.model.Currency> getAllCurrenciesList(String sortBy) {
		Query<io.github.mpstudios56.cifra.model.Currency> q = createQuery(io.github.mpstudios56.cifra.model.Currency.class);
		return q.desc("isDefault").asc(sortBy).list();
	}

	public Map<String, io.github.mpstudios56.cifra.model.Currency> getAllCurrenciesByTtitleMap() {
...
//	}
	...
	public io.github.mpstudios56.cifra.model.Currency getHomeCurrency() {
		Query<io.github.mpstudios56.cifra.model.Currency> q = createQuery(io.github.mpstudios56.cifra.model.Currency.class);
		q.where(Expressions.eq("isDefault", "1")); //uh-oh
		io.github.mpstudios56.cifra.model.Currency homeCurrency = q.uniqueResult();
